...
export async function getCompanies(){return(await apiRequest<CompanyCatalog>("/api/v1/companies")).data;}
export async function getCompany(id:string){return(await apiRequest<CompanyProfile>(`/api/v1/companies/${id}`)).data;}
